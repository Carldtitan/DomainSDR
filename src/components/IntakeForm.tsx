    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <Panel>
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-white">Domain Intake</h1>
            <p className="mt-1 text-sm text-slate-400">Create one careful, high-fit sales campaign.</p>
          </div>
        </div>
        ...
        <form action={submit} className="grid gap-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Who would value this domain and why?"
            />
          </div>
