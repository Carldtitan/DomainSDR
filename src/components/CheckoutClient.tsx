    ...
    <div className="mx-auto max-w-xl py-10">
      <Panel>
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-slate-950 dark:text-white">Domain Intent Deposit</h1>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{domain}</p>
          </div>
        ...
        <div className="mt-8 rounded-md border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900">
          <p className="text-sm text-slate-500 dark:text-slate-400">Accepted sale amount</p>
          <p className="mt-1 text-3xl font-semibold text-slate-950 dark:text-white">{money(offer.amount)}</p>
